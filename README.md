...
*The file structure must be proper. You must write the code for a particular language in that particular folder. For example, write Cpp code in the C++ folder and java code in the java folder, etc.
